...
!!! I(Jason) needed this to work in python 3 so that is why I forked the original. This software is not stable, probably doesn't work on arch linux(which I use) let alone anything else. If you make it work feel free to send me a pull request.!!!!
