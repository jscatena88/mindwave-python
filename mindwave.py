import select, serial, threading, codecs
            ...
            while payload:
                ...
                while code == EXCODE:
                    ...
                    try:
                        ...
                        pass
                #print("Code is %X and is greater than 0x80: %r and is equal to HEADSET_CONNECTED: %r" % (code, (code < 0x80), (code == HEADSET_CONNECTED)))
                if code < bytes([0x80]):
                    ...
                    if code == POOR_SIGNAL:
                        ...
                        self.headset.poor_signal = ord(bytes([value]))
    ...
    def connect(self, headset_id=None):
        ...
        if headset_id:
            ...
            if not headset_id:
                self.autoconnect()
                return
        self.dongle.write(b''.join([CONNECT, codecs.decode(headset_id, 'hex')]))
